# DevOps Project Report: Automated CI/CD Pipeline for a Two Tier DevOps Web Application using Flask

Author: Ankit Kumar
Date: 2026
Project: Two Tier DevOps Web Application using Flask
    ...
    stages {
        stage('Clone Code') {
            steps {
                ...
                git branch: 'main', url: '[git branch: 'main', url: 'https://github.com/ankit85456/two-tier-devops-web-application.git'](git branch: 'main', url: 'https://github.com/ankit85456/two-tier-devops-web-application.git')'
            }
        }
